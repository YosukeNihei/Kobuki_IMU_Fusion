...
class PyTimedPose2DConsoleOut(OpenRTM_aist.DataFlowComponentBase):
	...
	def __init__(self, manager):
		...
		self._d_TimedPose2Ddata = RTC.TimedPose2D(RTC.Time(0,0),RTC.Pose2D(RTC.Point2D(0,0),0))
		"""
		"""
		self._TimedPose2DdataIn = OpenRTM_aist.InPort("TimedPose2Ddata", self._d_TimedPose2Ddata)
	...
	def onInitialize(self):
		...
		# Set InPort buffers
		self.addInPort("TimedPose2Ddata",self._TimedPose2DdataIn)
	...
	def onExecute(self, ec_id):
		if self._TimedPose2DdataIn.isNew():
			self._d_TimedPose2Ddata = self._TimedPose2DdataIn.read()

		print "X:"+str(self._d_TimedPose2Ddata.data.position.x) + " " + "Y:"+str(self._d_TimedPose2Ddata.data.position.y) + " " + "Angle" + str(self._d_TimedPose2Ddata.data.heading)
